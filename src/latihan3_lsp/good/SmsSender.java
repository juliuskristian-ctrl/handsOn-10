...
public class SmsSender extends NotificationSender {
    ...
    // Class ini harus:
    // 1. Call super constructor dengan "SmsSender" (diubah agar sesuai output)
    ...
    public boolean send(String recipient, String message) {
        if (recipient == null || message == null) {
         ...
         System.out.println("[SmsSender] ✓ Notification sent to: " + recipient); // Dihapus karena output dikontrol di testSender
        return true;
    }
